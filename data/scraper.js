...
async function hentaihome(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://www.hentaihome.net/?s=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: '@clovermods', resultado: postagem})
    })
    .catch(e => {
...
async function lojadomecanico(nome) {
  return new Promise((resolve, reject) => {
    axios.get(`https://busca.lojadomecanico.com.br/busca?q=${nome}`).then( ({data}) => {
      ...
      resolve({status: 200, autor: '@clovermods', resultado: dados})
    })
    .catch(e => {
      reject({status: 500, msg: `Erro no módulo`})
    });
...
async function animesFireSearch(nome) {
  return new Promise( (resolve, reject) => {
    axios.get(`https://animefire.plus/pesquisar/${encodeURI(nome.toLowerCase().replaceAll(' ', '-'))}`, {
      headers: {
...
async function animesFireEps(link) {
  return new Promise( (resolve, reject) => {
  if(!link.includes('animefire.plus')) throw new Error('Esse não é um link válido')
    axios.get(link, {
      headers: {
        "user-agent": "Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/105.0.5195.136 Mobile Safari/537.36",
        "cookie": "a=JvTevu353yc2390gXtq7FVvF7TfRZfos; sid=3bFGrp0wysJs82nHdQTevzpY8Xl-bSKaFx9B-Ez1AlV%2CXuoQsG9hEJ4N8-oSzG7n;"
...
async function randomGrupos(categoria) {
  return new Promise( (resolve, reject) => {
    ...
    .then( async ({data}) => {
      ...
      resolve({status: 200, criador: '@clovermods', resultado: dados2})
    })
    .catch(e => {
      reject(e)
    })
...
async function topFlix(query) {
  return new Promise((resolve, reject) => {
    ...
    .then( ({data}) => {
      ...
      resolve({status: 200, criador: '@clovermods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function ultimasNoticias() {
 return new Promise((resolve, reject) => {
   ...
   resolve({status: 200, autor: '@clovermods', resultado: dados2})
  })
   .catch(e => {
     reject(e)
   })
...
async function xvideosSearch(q) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, criador: '@clovermods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
...
async function xvideosDownloader(url) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, criador: '@clovermods', resultado: {titulo: dados1.name, desc: dados1.description, thumb: dados1.thumbnailUrl[0], link: dados1.contentUrl}})
    })
    .catch(e => {
      reject(e)
    });
...
async function iFunny() {
  return new Promise((resolve, reject) => {
    ...
    .then(res => {
      ...
      resolve({status: res.status, autor: '@clovermods', imagens: dados, videos: dados2})
    })
    .catch(e => {
      reject(e)
    });
...
async function amazonSearch(query) {
  return new Promise((resolve, reject) => {
    ...
    .then((res) => {
      ...
      resolve({status: res.status, autor: '@clovermods', resultado: dados})
    })
    .catch(e => {
      reject(e)
    });
